...
import com.android.systemui.cyanogenmod.cyanogenmodTarget;
...
public class SearchPanelView extends FrameLayout implements
    ...
    private cyanogenmodTarget mcyanogenmodTarget;
       ...
       final Runnable SetLongPress = new Runnable () {
            public void run() {
                if (!mSearchPanelLock) {
                    ...
                    mcyanogenmodTarget.launchAction(longList.get(mTarget));
        ...
        public void onTrigger(View v, final int target) {
            mTarget = target;
            if (!mLongPress) {
		if (mcyanogenmodTarget.ACTION_ASSIST.equals(intentList.get(target))) {
                    startAssistActivity();
                } else {
                    try {
                    ...
                    mcyanogenmodTarget.launchAction(intentList.get(target));
                }
                mHandler.removeCallbacks(SetLongPress);
            }
        }
