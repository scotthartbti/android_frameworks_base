...
public class ColorPickerDialog extends Dialog implements
    ...
    private void setUp(int color) {
        ...
        View layout = inflater.inflate(com.android.internal.R.layout.dialog_color_picker, null);
        setContentView(layout);
        mColorPicker = (ColorPickerView) layout.findViewById(
                com.android.internal.R.id.color_picker_view);
        mOldColor = (ColorPickerPanelView) layout.findViewById(
    ...
    public void onClick(View v) {
        if (v.getId() == com.android.internal.R.id.new_color_panel) {
            if (mListener != null) {
